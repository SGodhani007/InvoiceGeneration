...
INSERT INTO `invoice` (`SID`, `INVOICE_NO`, `INVOICE_DATE`, `CNAME`, `CADDRESS`, `C_CITY`, `GRAND_TOTAL`) VALUES
(1, 1, '2024-07-07', 'Sahil Godhani', '61, Prabhudarshan Row House, Shyamdham Chowk, Nana Varachha', 'Surat', 9585000),
(2, 2, '2024-07-08', 'Sanket Keshwani', 'Radha Sarees', 'Varanasi', 225000);
